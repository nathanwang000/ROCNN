-- This is the function that uses small rorigid
require 'package'
...
function createModel(opt)
   ...
   model:add(nn.Rorigid(8,16,80,4,4,true,4,4)) -- 8*80*1*1
   model:add(nn.ReLU())
   model:add(nn.Rorigid(8,80,10,1,1,true,1,1)) -- 8*10*1*1
   model:add(nn.ReLU())
